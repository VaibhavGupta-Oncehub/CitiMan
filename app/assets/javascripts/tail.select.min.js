...
!(function (e) {
  ...
  function s(e, t, i) {
    if (CustomEvent && CustomEvent.name) var n = new CustomEvent(t, i);
      ...
      (n = d.createEvent("CustomEvent")).initCustomEvent(
        t,
        !!i.bubbles,
        !!i.cancelable,
        i.detail
  ...
  var u,
    p = function (e, t) {
      if (
        (e = "string" == typeof e ? d.querySelectorAll(e) : e) instanceof
          NodeList ||
        e instanceof HTMLCollection ||
        e instanceof Array
      ) {
        for (var i = [], n = e.length, s = 0; s < n; s++)
          i.push(new p(e[s], h(t, {})));
        return 1 === i.length ? i[0] : 0 !== i.length && i;
      }
      if (!(e instanceof Element && this instanceof p))
        return e instanceof Element && new p(e, t);
      if (p.inst[e.getAttribute("data-tail-select")])
        return p.inst[e.getAttribute("data-tail-select")];
      if (e.getAttribute("data-select")) {
        var l = JSON.parse(e.getAttribute("data-select").replace(/\'/g, '"'));
        l instanceof Object && (t = h(t, l));
      }
      var o =
        ...
        a = "sourceHide";
      return (
        ((t = "object" == typeof t ? t : {}).multiple =
          "multiple" in t ? t.multiple : e.multiple),
        (t.disabled = "disabled" in t ? t.disabled : e.disabled),
        (t.placeholder = o || t.placeholder || null),
        (t.width = "auto" === t.width ? e.offsetWidth + 50 : t.width),
        (t.sourceBind = r in t ? t[r] : t.sourceBind || !1),
        (t.sourceHide = a in t ? t[a] : t.sourceHide || !0),
        (t.multiLimit = 0 <= t.multiLimit ? t.multiLimit : 1 / 0),
        (this.e = e),
        (this.id = ++p.count),
        (this.con = h(p.defaults, t)),
        (this.events = {}),
        (p.inst["tail-" + this.id] = this).init().bind()
      );
    };
  return (
    (p.version = "0.5.5"),
    ...
    (p.strings = {
      ...
      modify: function (e, t, i) {
        ...
        if (t instanceof Object) for (var n in t) this.modify(e, n, t[n]);
    ...
    (p.prototype = {
      init: function () {
        ...
        e.push(n && n.push ? n.join(" ") : n && n.split ? n : "no-classes"),
          i.hideSelected && e.push("hide-selected"),
          i.hideDisabled && e.push("hide-disabled"),
          0 == i.multiLimit && e.push("disabled"),
          i.multiple && e.push("multiple"),
          i.deselect && e.push("deselect"),
          i.disabled && e.push("disabled"),
          (this.__ = p.strings[i.locale] || p.strings.en),
          (this._init = !0),
          (this._query = !1),
          (this.select = g("DIV", e)),
          (this.label = g("DIV", "select-label")),
          (this.dropdown = g("DIV", "select-dropdown")),
          (this.search = g("DIV", "dropdown-search")),
          (this.csvInput = g("INPUT", "select-search")),
          i.width &&
          /^[0-9.]+(?:cm|mm|in|px|pt|pc|em|ex|ch|rem|vw|vh|vmin|vmax|\%)$/i.test(
            i.width
          )
            ? (this.select.style.width = i.width)
            : i.width &&
              !isNaN(parseFloat(i.width, 10)) &&
              (this.select.style.width = i.width + "px"),
          this.label.addEventListener("click", function (e) {
            t.toggle.call(t, t.con.animate);
          }),
          this.select.appendChild(this.label),
          isNaN(parseInt(i.height, 10)) ||
            (this.dropdown.style.maxHeight = parseInt(i.height, 10) + "px"),
          i.search &&
            ((this.search.innerHTML =
              '<input type="text" class="search-input" />'),
            (this.search.children[0].placeholder = this.__.search),
            this.search.children[0].addEventListener("input", function (e) {
              t.query.call(t, 2 < this.value.length ? this.value : void 0);
            }),
          ...
          i.multiple &&
            i.multiContainer &&
            (d.querySelector(i.multiContainer)
              ? ((this.container = d.querySelector(i.multiContainer)),
                (this.container.className += " tail-select-container"))
              : !0 === i.multiContainer &&
                ((this.container = this.label),
                (this.container.className += " tail-select-container"))),
          (this.options = new u(this.e, this));
        for (var s = this.e.options.length, l = 0; l < s; l++)
          this.options.set(this.e.options[l], !1);
        for (var o in i.items)
          "string" == typeof i.items[o] && (i.items[o] = { value: i.items[o] }),
            this.options.add(
              i.items[o].key || o,
              i.items[o].value,
              i.items[o].group,
        ...
        return (
          ...
          t.con.startOpen && this.open(i.animate),
          (i.cbComplete || function () {}).call(this, this.select),
          (this._init = !1),
          this
        );
      },
        ...
        return (
          d.addEventListener("keydown", function (e) {
            var t,
              ...
              s,
              l = e.keyCode || e.which;
            if (!b(r.select, "active") || [13, 27, 38, 40].indexOf(l) < 0)
              return !1;
            if (
              (e.preventDefault(),
              e.stopPropagation(),
              13 == l &&
                (t = r.dropdown.querySelector(
                  ".dropdown-option.hover:not(.disabled)"
                )) &&
                r.options.select.call(r.options, t),
              27 == l || 13 == l)
            )
              return r.close(r.con.animate);
            if (
              (t = r.dropdown.querySelector(
                ".dropdown-option.hover:not(.disabled)"
              ))
              ...
              for (
                c(t, "hover"),
                  n = [(40 == l ? "next" : "previous") + "ElementSibling"];
                (t =
                  null !== (s = t[n]) && "LI" == t.tagName
                    ? s
                    : null !== (s = t.parentElement[n]) &&
                      0 < s.children.length &&
                      "UL" == s.tagName &&
                      s.children[40 == l ? 0 : s.children.length - 1]) &&
                (!b(t, "dropdown-option") || b(t, "disabled"));
            ...
            if (
              ...
              t && (i = r.dropdown.querySelector(".dropdown-inner")))
            ) {
              var o = (function (e) {
                for (
              ...
              a(t, "hover"),
                o.top + 2 * o.height > i.offsetHeight + i.scrollTop
                  ? i.scrollBy(
                      0,
                      o.top + 2 * o.height - (i.offsetHeight + i.scrollTop)
                    )
                  : o.top - o.height < i.scrollTop &&
                    i.scrollBy(0, -Math.abs(i.scrollTop - o.top + o.height));
            }
            return !0;
          }),
          d.addEventListener("click", function (e) {
            if (!b(r.select, "active") || b(r.select, "idle")) return !1;
            if (!0 === r.con.stayOpen) return !1;
            for (
              var t = [r.e, r.select, r.container], i = t.length, n = 0;
              n < i;
              n++
            ) {
              if (t[n] && (t[n].contains(e.target) || t[n] == e.target))
                return !1;
              if (!e.target.parentElement) return !1;
            }
            return r.close.call(r, r.con.animate);
          }),
          this.con.sourceBind &&
            this.e.addEventListener("change", function (e) {
              ...
              if (
                ...
                r.options.select.call(
                  r.options,
                  this.options[this.selectedIndex]
                );
              else {
                var t = [].concat(r.options.selected),
                  i = [].filter.call(
                    this.querySelectorAll("option:checked"),
                    function (e) {
                      return (
                        !(0 <= t.indexOf(e)) || (t.splice(t.indexOf(e), 1), !1)
                      );
                    }
                  );
                r.options.walk.call(r.options, "unselect", t),
                  r.options.walk.call(r.options, "select", i);
              }
            }),
          !0
        );
      ...
      callback: function (e, t, i) {
        ...
        return (
          s && 0 <= ["select", "disable"].indexOf(t)
            ? a(s, "select" == t ? "selected" : "disabled")
            : s &&
              0 <= ["unselect", "enable"].indexOf(t) &&
              c(s, "unselect" == t ? "selected" : "disabled"),
          this.update(e),
      ...
      trigger: function (e) {
        ...
        "change" == e &&
          arguments[2] &&
          0 <= arguments[2].indexOf("select") &&
          (s(this.e, "input", t), s(this.e, "change", t)),
          s(this.select, "tail::" + e, t);
        var i,
          n = [];
        return (
      ...
      calc: function () {
        ...
        ((e = this.dropdown.cloneNode(!0)).style.cssText =
          ...
          (t = t > e.clientHeight ? e.clientHeight : t),
          this.con.search &&
            (i = e.querySelector(".dropdown-search").clientHeight),
          this.dropdown.parentElement.removeChild(e);
        var s = this.select.getBoundingClientRect(),
          l = r.innerHeight - (s.top + s.height),
          o = l < t + i && s.top > l;
        return (
          !0 === this.con.openAbove || (!1 !== this.con.openAbove && o)
            ? ((o = !0),
              (t = Math.min(t, s.top - 10)),
              a(this.select, "open-top"))
            : ((o = !1), (t = Math.min(t, l - 10)), c(this.select, "open-top")),
          n &&
            ((this.dropdown.style.maxHeight = t + "px"),
            (n.style.maxHeight = t - i + "px")),
          this
        );
      },
      query: function (e, t) {
        var i,
          ...
          o,
          r,
          a = g("DIV", "dropdown-inner"),
          c = this,
          h = e ? "finder" : "walker",
          d = this.con,
          u = "getAttribute",
          p = e ? [e, t] : [d.sortItems, d.sortGroups];
        for (
          this._query = "string" == typeof e && e;
          (i = this.options[h].apply(this.options, p));

        ) {
          if (!s || (s && s[u]("data-group") !== i.group)) {
            if (
              !(
                (n = (d.cbLoopGroup || this.cbGroup).call(
                  this,
                  i.group,
                  e,
                  a
              ...
              break;
            (s = n).setAttribute("data-group", i.group), a.appendChild(s);
          }
          if (
            null !== (l = (d.cbLoopItem || this.cbItem).call(this, i, s, e, a))
          ) {
            if (!1 === l) break;
            l.setAttribute("data-key", i.key),
              l.setAttribute("data-group", i.group),
              l.addEventListener("click", function (e) {
                if (!this.hasAttribute("data-key")) return !1;
                var t = this[u]("data-key"),
                  i = this[u]("data-group") || "#";
                c.options.toggle.call(c.options, t, i) &&
                  (!1 !== c.con.stayOpen ||
                    c.con.multiple ||
                    c.close.call(c, c.con.animate));
              }),
              s.appendChild(l);
          }
        }
        var f = a.querySelectorAll("*[data-key]").length;
        0 == f &&
          (
            this.con.cbEmpty ||
            function (e) {
          ...
          0 < f &&
            ...
            d.multiSelectAll &&
            ((o = g("BUTTON", "tail-all")),
            (r = g("BUTTON", "tail-none")),
            (o.innerText = this.__.actionAll),
            o.addEventListener("click", function (e) {
              e.preventDefault();
              var t = c.dropdown.querySelectorAll(
                ".dropdown-inner .dropdown-option"
              );
              c.options.walk.call(c.options, "select", t);
            }),
            (r.innerText = this.__.actionNone),
            r.addEventListener("click", function (e) {
              e.preventDefault();
              var t = c.dropdown.querySelectorAll(
                ".dropdown-inner .dropdown-option"
              );
              c.options.walk.call(c.options, "unselect", t);
            }),
            (l = g("SPAN", "dropdown-action")).appendChild(o),
            l.appendChild(r),
            a.insertBefore(l, a.children[0]));
        var m = this.dropdown.querySelector(".dropdown-inner");
        return (
          this.dropdown[(m ? "replace" : "append") + "Child"](a, m),
          b(this.select, "active") && this.calc(),
      ...
      cbGroup: function (e, t) {
        var i,
          n,
          s = g("UL", "dropdown-optgroup"),
          l = this;
        return (
          "#" == e ||
            ((s.innerHTML = '<li class="optgroup-title"><b>' + e + "</b></li>"),
            this.con.multiple &&
              this.con.multiLimit == 1 / 0 &&
              this.con.multiSelectAll &&
              ((i = g("BUTTON", "tail-none")),
              (n = g("BUTTON", "tail-all")),
              (i.innerText = this.__.none),
      ...
      cbItem: function (e, t, i) {
        ...
        return (
          i && 0 < i.length && this.con.searchMarked
            ? (n.innerHTML = e.value.replace(
                new RegExp("(" + i + ")", "i"),
                "<mark>$1</mark>"
              ))
            : (n.innerText = e.value),
          this.con.descriptions &&
            e.description &&
            (n.innerHTML +=
              '<span class="option-description">' + e.description + "</span>"),
          n
        );
      },
      update: function (e) {
      ...
      updateLabel: function (e) {
        if (this.container == this.label && 0 < this.options.selected.length)
          return (
        ...
        return (
          "string" != typeof e &&
            (e = i.disabled
              ...
              ? "empty" + (b(this.select, "in-search") ? "Search" : "")
              : i.multiLimit <= n
              ? "limit"
              : !i.multiple && 0 < this.options.selected.length
              ? this.options.selected[0].innerText
              : "string" == typeof i.placeholder
              ? i.placeholder
              : "placeholder" +
                (i.multiple && i.multiLimit < 1 / 0 ? "Multi" : "")),
          (e =
            '<span class="label-inner">' +
            (e = (this.__[e] || e).replace(":limit", i.multiLimit)) +
            "</span>"),
          (t = i.multiShowLimit && i.multiLimit < 1 / 0),
          i.multiple &&
            i.multiShowCount &&
            (e = (e = '<span class="label-count">:c</span>' + e).replace(
              ":c",
              n + (t ? " / " + i.multiLimit : "")
            )),
      ...
      updateContainer: function (e) {
        ...
        if (e.selected) {
          ...
          (i.innerText = e.value),
            i.setAttribute("data-key", e.key),
            i.setAttribute("data-group", e.group),
            i.addEventListener("click", function (e) {
      ...
      updatePin: function (e) {
        ...
        if (((i = this.dropdown.querySelector(i)), e.selected))
          ...
          for (
            var n = this.dropdown.querySelector(
            ...
            s &&
            s.group == e.group &&
            !(l = n.querySelector("li[data-key='" + s.key + "']"));

          )
            s = this.options[s.index - 1];
          l && l.nextElementSibling
            ? n.insertBefore(i, l.nextElementSibling)
            : n.appendChild(i);
        }
        return this;
      },
      updateCSV: function (e) {
        ...
        for (var t = [], i = this.options.selected.length, n = 0; n < i; n++)
          t.push(this.options.selected[n].value);
        return (
          ...
          !1 !== e
            ? ((this.label.style.zIndex = 25),
              ...
              (function e() {
                ...
                (l.height = (i < t + 50 ? i : t + 50) + "px"),
                  setTimeout(e, 20);
              })())
            : ((l.cssText =
                "height:" + l.maxHeight + ";display:block;overflow:hidden;"),
              n.call(this)),
          this
        );
      },
          ...
          !1 !== e
            ? (a(this.select, "idle"),
              ...
              (function e() {
                ...
                (n.style.height = parseInt(n.offsetHeight, 10) - 50 + "px"),
                  setTimeout(e, 20);
              })())
            : t.call(this),
          this
      ...
      enable: function (e) {
        return (
          c(this.select, "disabled"),
          (this.e.disabled = !1),
          (this.con.disabled = !1) === e ? this : this.reload()
        );
      },
      disable: function (e) {
        return (
          a(this.select, "disabled"),
          (this.e.disabled = !0),
          !(this.con.disabled = !0) === e ? this : this.reload()
        );
      },
      on: function (e, t, i) {
        return (
          !(
            ["open", "close", "change"].indexOf(e) < 0 || "function" != typeof t
          ) &&
    ...
    ((u = p.options =
      ...
      get: function (e, t) {
        var i = "getAttribute";
        if ("object" == typeof e && e.key && e.group)
          (t = e.group || t), (e = e.key);
        else if (e instanceof Element)
          "OPTION" == e.tagName
            ? ((t = e.parentElement.label || "#"), (e = e.value || e.innerText))
            : e.hasAttribute("data-key") &&
              ((t =
                e[i]("data-group") || e.parentElement[i]("data-group") || "#"),
              (e = e[i]("data-key")));
        else {
      ...
      set: function (e, t) {
        ...
        if (
          (n in this.items ||
            ((this.items[n] = {}), (this.groups[n] = e.parentElement)),
          i in this.items[n])
        )
          return !1;
        var s = this.self.con;
        if (
          (((!s.multiple && 0 < this.selected.length) ||
            (s.multiple && this.selected.length >= s.multiLimit)) &&
            (e.selected = !1),
          !e.selected ||
            !s.deselect ||
            (e.hasAttribute("selected") && 0 != s.multiLimit) ||
            ((e.selected = !1), (e.parentElement.selectedIndex = -1)),
          e.hasAttribute("data-description"))
        ) {
          var l = g("SPAN");
          (l.innerHTML = e.getAttribute("data-description")),
            e.setAttribute("data-description", l.innerHTML);
        }
        return (
          (this[this.length++] = this.items[n][i] =
            {
              key: i,
              value: e.text,
              index: this.length - 1,
          ...
          e.selected && this.select(this.items[n][i]),
          e.disabled && this.disable(this.items[n][i]),
      ...
      add: function (e, t, i, n, s, l, o) {
        ...
        if (
          ...
          var a = g("OPTGROUP");
          (a.label = i),
            a.setAttribute("data-select-optgroup", "add"),
            this.element.appendChild(a),
            (this.items[i] = {}),
            (this.groups[i] = a);
        }
        var c = this.self.con;
        ((!c.multiple && 0 < this.selected.length) ||
          (c.multiple && this.selected.length >= c.multiLimit)) &&
          (n = !1),
          (s = !!s);
        var h = d.createElement("OPTION");
        return (
          (h.value = e),
          (h.selected = n),
          (h.disabled = s),
          (h.innerText = t),
          h.setAttribute("data-select-option", "add"),
          l && 0 < l.length && h.setAttribute("data-description", l),
          ("#" == i ? this.element : this.groups[i]).appendChild(h),
          this.set(h, o)
        );
      },
      ...
      remove: function (e, t, i) {
        return (
          ...
          Array.prototype.splice.call(this, e.index, 1),
          delete this.items[e.group][e.key],
      ...
      is: function (e, t, i) {
        e = this._r(e);
        var n = this.get(t, i);
        return !n || ["select", "unselect", "disable", "enable"].indexOf(e) < 0
          ? null
          : "disable" == e || "enable" == e
          ? "disable" == e
            ? n.disabled
            : !n.disabled
          : ("select" == e || "unselect" == e) &&
            ("select" == e ? n.selected : !n.selected);
      },
      handle: function (e, t, i, n) {
        var s = this.get(t, i);
        e = this._r(e);
        if (!s || ["select", "unselect", "disable", "enable"].indexOf(e) < 0)
          return null;
        if ("disable" == e || "enable" == e)
          return (
            s.option in this.disabled || "disable" != e
              ? s.option in this.disabled &&
                "enable" == e &&
                this.disabled.splice(this.disabled.indexOf(s.option), 1)
              : this.disabled.push(s.option),
            (s.disabled = "disable" == e),
            (s.option.disabled = "disable" == e),
            this.self.callback.call(this.self, s, e)
          );
        var l =
            b(this.self.select, "disabled") || s.disabled || s.option.disabled,
          o =
        ...
        if ("select" == e) {
          ...
          if (!this.self.con.multiple)
            for (var h in this.selected)
              this.unselect(this.selected[h], void 0, !0);
        ...
        return (
          (s.selected = "select" == e),
          (s.option.selected = "select" == e),
          s.option[(6 < e.length ? "remove" : "set") + "Attribute"](
            "selected",
            "selected"
          ),
          this.self.callback.call(this.self, s, e, n)
        );
      },
      enable: function (e, t) {
      ...
      invert: function (t) {
        if (((t = this._replaceType(t)), 0 <= ["enable", "disable"].indexOf(t)))
          var i = this.disabled,
            n = "enable" == t ? "disable" : "enable";
        else if (0 <= ["select", "unselect"].indexOf(t))
          (i = this.selected), (n = "select" == t ? "unselect" : "select");
      ...
      all: function (t, i) {
        ...
        return (
          i in this.items
            ? (e = Object.keys(this.items[i]))
            : 0 <= ["unselect", "enable"].indexOf(t) &&
              (e = [].concat("unselect" == t ? this.selected : this.disabled)),
      ...
      walk: function (t, e, i) {
        if (e instanceof Array || e.length)
          for (var n = e.length, s = 0; s < n; s++)
            this.handle.apply(this, [t, e[s], null].concat(i));
          ...
          if (e.forEach)
            ...
            for (var o in e)
              ("string" == typeof e[o] ||
                "number" == typeof e[o] ||
                e[o] instanceof Element) &&
                this.handle
                  .apply(this, [t, e[o], o in this.items ? o : null])
                  .concat(i);
        }
        return this;
      },
      find: function (e, i) {
        var n = new RegExp(e, "im"),
          s = [],
          l = this,
          o = function (e) {
            return n.test(e.text || e.value);
          };
        return (
            ...
            return (
              !!("any" == i
                ? ((t = e),
                  n.test(t.text) ||
                    n.test(t.value) ||
                    0 < Array.apply(null, t.attributes).filter(o).length)
                : o(e)) &&
              !(0 <= l.disabled.indexOf(e) && !l.self.con.searchDisabled) &&
              void s.push(l.get(e))
            );
            var t;
          }),
      ...
      walker: function (e, t) {
        ...
        return (
          "ASC" == t
            ...
            : "DESC" == t
            ? l.sort().reverse()
            : "function" == typeof t && (l = t.call(this, l)),
          l.unshift("#"),
          (this._inLoop = !0),
          (this._inItems = []),
          (this._inGroups = l),
